...
public class LoginUser extends javax.swing.JFrame {
    ...
    public LoginUser() {
        ...
        setResizable(false);
        setDefaultCloseOperation(LoginUser.EXIT_ON_CLOSE);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(controller.LogIn(username, pass)){
            this.dispose();
            new ListTask().setVisible(true); // Main Form to show after the Login Form..
        }
        else{
            jLabel3.setText("User Not Found");
